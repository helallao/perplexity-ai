...
class Emailnator(AsyncMixin):
    async def __ainit__(self, headers, cookies, domain=False, plus=False, dot=False, google_mail=True):
        self.inbox = []
        self.inbox_ads = []
        
        self.s = requests.AsyncSession(headers=headers, cookies=cookies)
